...
plot \
"/Scratch/ugochi/mglur1/analysis/PCA/PROA/projection-prob1.txt" using 1:2:0 with p ps 3 lt 7 palette title "",
...
ps2epsi fig-prob-pca.ps
epstopdf fig-prob-pca.epsi
rm fig-prob-pca.ps fig-prob-pca.epsi
